...
class auth_plugin_tuis_auth extends auth_plugin_base {
    ...
    function user_login($username, $password) 
    {
        ...
        if (!function_exists('tuis_check_auth')) {
            print_error('auth_tuis_authnotinstalled', 'auth_tuis_auth');
            exit;
        }
    ...
    function get_title() {
        return get_string("auth_tuis_authauthtitle", "auth_tuis_auth");
    }


    function get_description() {
        return get_string("auth_tuis_authauthdescription", "auth_tuis_auth");
    }
}
